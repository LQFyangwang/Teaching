	...
	<div class="box">
		<div class="login-box">
			...
			<div class="login-content ">
							...
							<div class="col-xs-12  ">
								...
								<div class="input-group">
									<span class="input-group-addon"><span
										...
										id="phone" name="stu.phone" class="form-control"
										placeholder="登入手机号">
								</div>
							</div>
						</div>
							...
							<div class="col-xs-12  ">
								<div class="input-group">
									<span class="input-group-addon"><span
										...
										type="password" id="pwd" name="stu.pwd" class="form-control"
										placeholder="密&nbsp;&nbsp;码">
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-xs-12  ">
								<div class="input-group">
									...
									<input type="text" id="code" name="code" style="padding-left: 10px;" class="form-control1"
										placeholder="&nbsp;&nbsp;&nbsp;验证码"> 
									<input type="button" onclick="createCode()" readonly="readonly"
										id="checkCode" class="unchanged"
										style="color: red; font-weight: bold; width: 120px; height: 40px; background-image: url('<%=path%>/images/0.jpg');"
										value="点击获取验证码" />
								</div>
							</div>
						</div>
				...
				<a href="<%=path %>" style="margin-left: 80px;" >返回首页</a>
			</div>
		</div>
	</div>
</body>
