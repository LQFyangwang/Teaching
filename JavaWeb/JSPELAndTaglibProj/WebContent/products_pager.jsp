...
<body>
	...
	<a href="<%=path %>/product/pager?pageNo=${requestScope.currentPage - 1}">上一页</a>
	<a href="<%=path %>/product/pager?pageNo=${requestScope.currentPage + 1}">下一页</a>
	<a href="<%=path %>/product/pager?pageNo=${requestScope.totalPage}">尾页</a>
